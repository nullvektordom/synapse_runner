...
const TaskEntitySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'reminderFrequencyMinutes': PropertySchema(
      id: 3,
      name: r'reminderFrequencyMinutes',
      type: IsarType.long,
    ),
...
void _taskEntitySerialize(
  ...
  writer.writeLong(offsets[3], object.reminderFrequencyMinutes);
...
TaskEntity _taskEntityDeserialize(
  ...
  final object = TaskEntity(
    ...
    reminderFrequencyMinutes: reader.readLongOrNull(offsets[3]) ?? 5,
...
extension TaskEntityQueryFilter
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition>
      reminderFrequencyMinutesEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'reminderFrequencyMinutes',
        value: value,
      ));
    });
  }
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition>
      reminderFrequencyMinutesGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition>
      reminderFrequencyMinutesLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition>
      reminderFrequencyMinutesBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> startTimeEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> startTimeLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterFilterCondition> startTimeBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TaskEntityQuerySortBy
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy> sortByDurationMinutes() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy>
      sortByReminderFrequencyMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminderFrequencyMinutes', Sort.asc);
    });
  }

  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy>
      sortByReminderFrequencyMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminderFrequencyMinutes', Sort.desc);
    });
  }

  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy> sortByStartTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'startTime', Sort.asc);
    });
  }

  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy> sortByStartTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskEntityQuerySortThenBy
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy> thenByDurationMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'durationMinutes', Sort.asc);
    });
  }
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy>
      thenByReminderFrequencyMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminderFrequencyMinutes', Sort.asc);
    });
  }
  ...
  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy>
      thenByReminderFrequencyMinutesDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'reminderFrequencyMinutes', Sort.desc);
    });
  }

  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy> thenByStartTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'startTime', Sort.asc);
    });
  }

  QueryBuilder<TaskEntity, TaskEntity, QAfterSortBy> thenByStartTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'startTime', Sort.desc);
    });
  }
...
extension TaskEntityQueryWhereDistinct
  ...
  QueryBuilder<TaskEntity, TaskEntity, QDistinct> distinctByDurationMinutes() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, TaskEntity, QDistinct>
      distinctByReminderFrequencyMinutes() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'reminderFrequencyMinutes');
    });
  }

  QueryBuilder<TaskEntity, TaskEntity, QDistinct> distinctByStartTime() {
    return QueryBuilder.apply(this, (query) {
...
extension TaskEntityQueryProperty
  ...
  QueryBuilder<TaskEntity, int?, QQueryOperations> durationMinutesProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TaskEntity, int, QQueryOperations>
      reminderFrequencyMinutesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'reminderFrequencyMinutes');
    });
  }

  QueryBuilder<TaskEntity, DateTime, QQueryOperations> startTimeProperty() {
    return QueryBuilder.apply(this, (query) {
